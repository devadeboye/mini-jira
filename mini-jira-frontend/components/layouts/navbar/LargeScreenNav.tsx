	...
	return (
		<div className={`${className} w-full flex items-center gap-3`}>
			...
			<div className="lg:flex lg:w-full lg:items-center lg:justify-center lg:gap-2">
				{/* Search box */}
				<div className="lg:flex lg:items-center lg:gap-2 lg:border lg:border-gray-400 lg:rounded lg:focus-within:border-primary lg:focus-within:ring-1 lg:focus-within:ring-primary lg:px-2 lg:py-1 lg:w-full">
					<SearchIcon
						height={24}
						width={24}
